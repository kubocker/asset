...
=> "800"
  ...
  # ?        # 486      # 363     # 045      # 839        # 545      # 347      # 138      # 437        # 092
 0 -> xxxx  0 ->       0 -> x     0 -> x    0 -> xxxxxx  0 ->       0 ->       0 ->       0 -> x      0 ->
 1 -> xx    1 -> xxx   1 -> x     1 -> xx   1 -> x       1 -> x     1 -> xxx   1 -> xxx   1 -> x      1 -> xx
 2 -> x     2 -> xxx   2 -> xxx   2 -> x    2 -> xx      2 -> xx    2 -> xx    2 -> xx    2 -> xxxxx  2 -> xxx
 3 ->       3 -> xxxx  3 -> xx    3 -> xxx  3 -> xx      3 -> xx    3 -> xxx   3 -> xxx   3 -> x      3 -> xxx
 4 -> xxx   4 -> x     4 -> xxx   4 -> x    4 -> x       4 -> xx    4 -> xx    4 -> xxxx  4 -> xx     4 -> 
 5 -> x     5 ->       5 -> x     5 -> xx   5 -> xxx     5 -> x     5 ->       5 -> x     5 -> x      5 -> xx
 6 -> x     6 -> x     6 ->       6 -> x    6 -> xx      6 -> x     6 -> x     6 -> xx    6 -> x      6 -> xx
 7 ->       7 -> x     7 -> x     7 -> xx   7 -> x       7 -> xxxx  7 ->       7 -> x     7 -> x      7 -> xx
 8 -> xxx   8 -> x     8 -> x     8 -> xx   8 ->         8 ->       8 -> xxx   8 ->       8 -> x      8 -> x
 9 -> xxx   9 -> xx    9 -> x     9 -> x    9 ->         9 -> xx    9 -> x     9 -> x     9 -> xx     9 -> xx
 [0,2,0]    [1,1,1]    [2,0,2]   [1,1,2]    [0,2,0]     [1,2,1]    [3,2,0]    [3,3,0]     [2,1,1]     [0,2,3]
 [0,2,3]
 [1,2,1]
 [3,3,0]
 [1,1,1]
